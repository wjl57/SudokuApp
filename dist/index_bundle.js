...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sudokuBoard = __webpack_require__(159);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sudokuPreference = __webpack_require__(169);

	var _sudokuPreference2 = _interopRequireDefault(_sudokuPreference);

	var _sudokuStepsLog = __webpack_require__(170);

	var _sudokuStepsLog2 = _interopRequireDefault(_sudokuStepsLog);

	var _reactDropdown = __webpack_require__(171);

	var _reactDropdown2 = _interopRequireDefault(_reactDropdown);

	var _reactTabs = __webpack_require__(172);
	...
	exports.default = _react2.default.createClass({
	  ...
	  stringifyBoardState: function stringifyBoardState(boardState) {
	    var possibilities = [];
	    for (var y = 0; y < 9; y++) {
	      possibilities.push([]);
	      for (var x = 0; x < 9; x++) {
	  ...
	  saveBoardState: function saveBoardState(num, newBoardState, newFreeEdit) {
	    ...
	    return function () {
	      ...
	      var boardStateToSave = newBoardState === undefined ? self.stringifyBoardState(self.state.boardState) : self.stringifyBoardState(newBoardState);
	  ...
	  loadNewBoard: function loadNewBoard(board) {
	  ...
	  loadPossibilities: function loadPossibilities(possibilities) {
	    var newBoardState = this.state.boardState;
	    for (var y = 0; y < 9; y++) {
	      for (var x = 0; x < 9; x++) {
	  ...
	  onlevelSelect: function onlevelSelect(option) {
	  ...
	  render: function render() {
	    ...
	    for (var candidate = 1; candidate <= 9; candidate++) {
	      ...
	      controls.push(_react2.default.createElement(
	        "td",
	        { style: controlTdStyle },
	        _react2.default.createElement(_sudokuControl2.default, controlProps)
	      ));
	    }
	    var togglePenProps = {
	      text: "Pen",
	    ...
	    controls.push(_react2.default.createElement(
	      "td",
	      { style: controlTdStyle },
	      _react2.default.createElement(_sudokuControl2.default, togglePenProps)
	    ));
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                      "li",
	                      null,
	                      "Select a candidate from under the puzzle"
	                    ),
	                    _react2.default.createElement(
	                      "li",
	                      null,
	                      "Click the desired cell in the puzzle"
	                    ),
	                    _react2.default.createElement(
	                      "li",
	                      null,
	                    ...
	                    _react2.default.createElement(
	                      "li",
	                      null,
	                      "To note possiblities instead, deselect \"Pen\""
	                    )
	                  ),
	                  _react2.default.createElement(
	                    "h4",
	                  ...
	                  _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                      "li",
	                      null,
	                      "Input the puzzle then click \"Start\""
	                    ),
	                    _react2.default.createElement(
	                      "li",
	                      null,
	                    ...
	                    _react2.default.createElement(
	                      "li",
	                      null,
	                      "Click \"Solve Step\" to solve a single cell"
	                    ),
	                    _react2.default.createElement(
	                      "li",
	                      null,
	                      "Click \"Calculate Possibilities\" to show all possibilities based on the current puzzle state"
	                    )
	                  )
	                ),
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                      "li",
	                      null,
	                      "Toggle a candidate (# keys)"
	                    ),
	                    _react2.default.createElement(
	                      "li",
	                      null,
	                      "Highlight a candidate (double press # keys)"
	                    ),
	                    _react2.default.createElement(
	                      "li",
	                      null,
	                ...
	                _react2.default.createElement(
	                  _reactTabs.TabPanel,
	                  null,
	                  _react2.default.createElement(_sudokuPreference2.default, {
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(_sudokuStepsLog2.default, { stepsLog: this.state.stepsLog })
	              )
	            )
	          )
	        )
	  ...
	  locToBlockNum: function locToBlockNum(y, x) {
	    return Math.floor(x / 3) + Math.floor(y / 3) * 3;
	  },

	  possibilityCallback: function possibilityCallback(y, x, candidate) {
	    var newBoardState = this.state.boardState;
	  ...
	  valCallback: function valCallback(y, x, candidate) {
	    var newBoardState = this.state.boardState;
	    var cellState = this.state.boardState[y][x];
	  ...
	  onClickCallback: function onClickCallback(y, x, valCallback, possibilityCallback) {
	  ...
	  togglePreference: function togglePreference(preferenceName) {
	    var self = this;
	    return function () {
	  ...
	  onTogglePenCallback: function onTogglePenCallback() {
	    if (!this.state.freeEdit) this.setState({ toggledKey: !this.state.toggledKey });
	  },
	  ...
	  calcPossibilities: function calcPossibilities() {
	    var newBoardState = this.state.boardState;
	    for (var y = 0; y < 9; y++) {
	      for (var x = 0; x < 9; x++) {
	    ...
	    var eliminatePosInCells = function eliminatePosInCells(cells) {
	  ...
	  getInvalidCells: function getInvalidCells(cells) {
	  ...
	  setValidityForCells: function setValidityForCells(cells, isInvalid, newBoardState) {
	  ...
	  recalcValidity: function recalcValidity() {
	    var newBoardState = this.state.boardState;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./my-style.css", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./my-style.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  TabList: __webpack_require__(178),
	  Tab: __webpack_require__(177),
	  TabPanel: __webpack_require__(180)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsStylesheet = __webpack_require__(174);

	var _jsStylesheet2 = _interopRequireDefault(_jsStylesheet);

	var _helpersUuid = __webpack_require__(175);

	var _helpersUuid2 = _interopRequireDefault(_helpersUuid);

	var _helpersChildrenPropType = __webpack_require__(176);
	...
	module.exports = _react2['default'].createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    if (useDefaultStyles) {
	      (0, _jsStylesheet2['default'])(__webpack_require__(179));
	    }
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsTab = __webpack_require__(177);

	var _componentsTab2 = _interopRequireDefault(_componentsTab);

	var _componentsTabList = __webpack_require__(178);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./dropdown-style.css", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./dropdown-style.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(objCtor!=othCtor&&'constructor' in object&&'constructor' in other&&!(typeof objCtor=='function'&&objCtor instanceof objCtor&&typeof othCtor=='function'&&othCtor instanceof othCtor)){result=false;}}return result;} /**
	   ...
	   */function isPrototype(value){var Ctor=value&&value.constructor,proto=isFunction(Ctor)&&Ctor.prototype||objectProto;return value===proto;} /**
	...
	if("function"=='function'&&_typeof(__webpack_require__(166))=='object'&&__webpack_require__(166)){ // Define as an anonymous module so, through path mapping, it can be
